...
def fetch_comprehensive_news_guaranteed_30_enhanced(company: str, days_back: int = 7) -> Dict[str, Any]:
    ...
    try:
        ...
        from enhanced_news_analysis import fetch_comprehensive_news_guaranteed_30_enhanced_WITH_ITERATIVE_QUALITY
        
        logger.info(f"🚀 Using QUALITY-ENHANCED PARALLEL system for {company}")
        
        # Call the quality-enhanced version
        results = fetch_comprehensive_news_guaranteed_30_enhanced_WITH_ITERATIVE_QUALITY(company, days_back)
